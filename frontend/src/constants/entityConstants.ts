...
export const ENTITY_TYPES = {
    ...
    LAND_ITEM_MASTER: 'land-item-master',
    BUDGET_ITEM_MASTER: 'budget-item-master',
    ...
    DEMO_UNIT_NAME: 'demo-unit-name-master',
...
export const ENTITY_PATHS = {
    ...
    DEMO_UNIT_NAME: '/all-master/demo-unit-name',
    ...
    LAND_ITEM_MASTER: '/all-master/land-item-master',
    BUDGET_ITEM_MASTER: '/all-master/budget-item-master',
