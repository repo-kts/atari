...
export const FIELD_NAMES = {
    ...
    PERCENT_COMMODITY_LOSS: 'percentCommodityLoss',
    PREVENTIVE_MEASURES_TAKEN: 'preventiveMeasuresTaken',
    ...
    TITLE_OF_THE_TRAINING_PROGRAMME: 'titleOfTheTrainingProgramme',
    MALE: 'male',
    FEMALE: 'female',
    AMOUNT_OF_FUND_RECEIVED: 'amountOfFundReceived',
    ...
    NUMBER_OF_MOBILE_APPS_DEVELOPED: 'numberOfMobileAppsDeveloped',
    NAME_OF_THE_APPS: 'nameOfTheApps',
    LANGUAGE_OF_THE_APPS: 'languageOfTheApps',
    MEANT_FOR: 'meantFor',
    NO_OF_TIMES_DOWNLOADED: 'noOfTimesDownloaded',
    NO_OF_VISITORS_VISITED: 'noOfVisitorsVisited',
    ...
    TYPE_OF_MESSAGES_CROP: 'typeOfMessagesCrop',
    TYPE_OF_MESSAGES_LIVESTOCK: 'typeOfMessagesLivestock',
    TYPE_OF_MESSAGES_WEATHER: 'typeOfMessagesWeather',
    TYPE_OF_MESSAGES_MARKETING: 'typeOfMessagesMarketing',
    TYPE_OF_MESSAGES_AWARENESS: 'typeOfMessagesAwareness',
    TYPE_OF_MESSAGES_OTHER_ENTERPRISES: 'typeOfMessagesOtherEnterprises',
    TYPE_OF_MESSAGES_ANY_OTHER: 'typeOfMessagesAnyOther',
    ADVISORIES_THROUGH_TEXT_MESSAGES: 'advisoriesThroughTextMessages',
    NO_OF_FARMERS_SENT_TEXT_MESSAGES: 'noOfFarmersSentTextMessages',
    ADVISORIES_THROUGH_WHATSAPP: 'advisoriesThroughWhatsapp',
    NO_OF_FARMERS_SENT_WHATSAPP: 'noOfFarmersSentWhatsapp',
    ADVISORIES_THROUGH_SOCIAL_MEDIA: 'advisoriesThroughSocialMedia',
    NO_OF_FARMERS_SENT_SOCIAL_MEDIA: 'noOfFarmersSentSocialMedia',
    ADVISORIES_THROUGH_WEATHER_ADVISORY_BULLETIN: 'advisoriesThroughWeatherAdvisoryBulletin',
    NO_OF_FARMERS_SENT_WEATHER_ADVISORY_BULLETIN: 'noOfFarmersSentWeatherAdvisoryBulletin',
