...
export const FIELD_NAMES = {
    ...
    SPECIFY_ITEM_NAME: 'specifyItemName',
    ...
    FUNDING_AGENCY_SPECIFY: 'fundingAgencyName',
...
export const FIELD_GROUPS = {
    ...
    LAND_ITEM_MASTER: [FIELD_NAMES.NAME, FIELD_NAMES.IS_OTHER] as const,
    BUDGET_ITEM_MASTER: [FIELD_NAMES.ITEM_NAME] as const,
    ...
    DEMO_UNIT_NAME_MASTER: [FIELD_NAMES.NAME_OF_DEMO_UNIT] as const,
    ...
    INFRASTRUCTURE_DETAILS: [
        ...
        FIELD_NAMES.FUNDING_AGENCY_SPECIFY,
