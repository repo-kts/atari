...
export const ENTITY_CATEGORIES = {
    ...
    PRODUCTION_PROJECTS: [
        ...
        ENTITY_TYPES.TSP_SCSP_TYPES,
        ENTITY_TYPES.TSP_SCSP_ACTIVITIES,
        ENTITY_TYPES.NATURAL_FARMING_ACTIVITIES,
        ENTITY_TYPES.NATURAL_FARMING_SOIL_PARAMETERS,
        ENTITY_TYPES.AGRI_DRONE_DEMONSTRATIONS_ON,
    ] as ExtendedEntityType[],
    PUBLICATIONS: [
    ...
    OTHER_MASTERS: [
        ...
        ENTITY_TYPES.LAND_ITEM_MASTER,
        ENTITY_TYPES.BUDGET_ITEM_MASTER,
        ...
        ENTITY_TYPES.NARI_ACTIVITY,
        ENTITY_TYPES.NARI_CROP_CATEGORY,
        ENTITY_TYPES.NARI_NUTRITION_GARDEN_TYPE,
        ENTITY_TYPES.NICRA_CATEGORY,
        ENTITY_TYPES.NICRA_SUB_CATEGORY,
        ENTITY_TYPES.NICRA_SEED_BANK_FODDER_BANK,
        ENTITY_TYPES.NICRA_DIGNITARY_TYPE,
        ENTITY_TYPES.NICRA_PI_TYPE,
        ENTITY_TYPES.TRAINING_CLIENTELE,
        ENTITY_TYPES.FUNDING_SOURCE,
        ENTITY_TYPES.EXTENSION_ACTIVITY_TYPE,
        ENTITY_TYPES.OTHER_EXTENSION_ACTIVITY_TYPE,
        ENTITY_TYPES.IMPACT_SPECIFIC_AREA,
        ENTITY_TYPES.DEMO_UNIT_NAME,
    ...
    PROJECTS: [
        ...
        ENTITY_TYPES.PROJECT_TSP_ACTIVITY,
        ENTITY_TYPES.PROJECT_SCSP_ACTIVITY,
...
export const getEntityTypeFromPathMap = (path: string): ExtendedEntityType | null => {
    ...
    const pathMap: Record<string, ExtendedEntityType> = {
        ...
        '/all-master/tsp-scsp-type': ENTITY_TYPES.TSP_SCSP_TYPES,
        '/all-master/tsp-scsp-activity': ENTITY_TYPES.TSP_SCSP_ACTIVITIES,
        '/all-master/natural-farming-activity': ENTITY_TYPES.NATURAL_FARMING_ACTIVITIES,
        '/all-master/natural-farming-soil-parameter': ENTITY_TYPES.NATURAL_FARMING_SOIL_PARAMETERS,
        ...
        '/all-master/land-item-master': ENTITY_TYPES.LAND_ITEM_MASTER,
        '/all-master/budget-item-master': ENTITY_TYPES.BUDGET_ITEM_MASTER,
        '/all-master/important-day': ENTITY_TYPES.IMPORTANT_DAY,
        '/all-master/soil-water-analysis': ENTITY_TYPES.SOIL_WATER_ANALYSIS,
        '/all-master/vehicle-present-status': ENTITY_TYPES.VEHICLE_PRESENT_STATUS,
        '/all-master/equipment-present-status': ENTITY_TYPES.EQUIPMENT_PRESENT_STATUS,
        '/all-master/nari-activity': ENTITY_TYPES.NARI_ACTIVITY,
        '/all-master/nari-crop-category': ENTITY_TYPES.NARI_CROP_CATEGORY,
        '/all-master/nari-nutrition-garden-type': ENTITY_TYPES.NARI_NUTRITION_GARDEN_TYPE,
        '/all-master/nicra-category': ENTITY_TYPES.NICRA_CATEGORY,
        '/all-master/nicra-sub-category': ENTITY_TYPES.NICRA_SUB_CATEGORY,
        '/all-master/nicra-seed-bank-fodder-bank': ENTITY_TYPES.NICRA_SEED_BANK_FODDER_BANK,
        '/all-master/nicra-dignitary-type': ENTITY_TYPES.NICRA_DIGNITARY_TYPE,
        '/all-master/nicra-pi-type': ENTITY_TYPES.NICRA_PI_TYPE,
        ...
        '/all-master/demo-unit-name': ENTITY_TYPES.DEMO_UNIT_NAME,
        ...
        '/forms/about-kvk/land-details': ENTITY_TYPES.KVK_LAND_DETAILS,
        ...
        '/forms/achievements/projects/sub-plan-activity/tsp': ENTITY_TYPES.PROJECT_TSP_ACTIVITY,
        '/forms/achievements/projects/sub-plan-activity/scsp': ENTITY_TYPES.PROJECT_SCSP_ACTIVITY,
