...
export const getEntityTypeFromPathMap = (path: string): ExtendedEntityType | null => {
    const pathMap: Record<string, ExtendedEntityType> = {
        ...
        '/forms/achievements/projects/seed-hub': ENTITY_TYPES.PROJECT_SEED_HUB,
        '/forms/achievements/projects/arya/current': ENTITY_TYPES.PROJECT_ARYA_CURRENT,
        '/forms/achievements/projects/arya/previous': ENTITY_TYPES.PROJECT_ARYA_EVALUATION,
        ...
        '/forms/achievements/projects/natural-farming/geographical': ENTITY_TYPES.PROJECT_NATURAL_FARMING_GEO,
        '/forms/achievements/projects/natural-farming/physical': ENTITY_TYPES.PROJECT_NATURAL_FARMING_PHYSICAL,
        '/forms/achievements/projects/natural-farming/demonstration': ENTITY_TYPES.PROJECT_NATURAL_FARMING_DEMO,
        '/forms/achievements/projects/natural-farming/farmers': ENTITY_TYPES.PROJECT_NATURAL_FARMING_FARMERS,
        '/forms/achievements/projects/natural-farming/beneficiaries': ENTITY_TYPES.PROJECT_NATURAL_FARMING_BENEFICIARIES,
        '/forms/achievements/projects/natural-farming/soil': ENTITY_TYPES.PROJECT_NATURAL_FARMING_SOIL,
        '/forms/achievements/projects/natural-farming/budget': ENTITY_TYPES.PROJECT_NATURAL_FARMING_BUDGET,
        ...
        '/forms/miscellaneous/performance/impact/kvk-activities': ENTITY_TYPES.PERFORMANCE_IMPACT_KVK_ACTIVITIES,
        '/forms/miscellaneous/performance/impact/entrepreneurship': ENTITY_TYPES.PERFORMANCE_IMPACT_ENTREPRENEURSHIP,
        '/forms/miscellaneous/performance/impact/success-stories': ENTITY_TYPES.PERFORMANCE_IMPACT_SUCCESS_STORIES,
        '/forms/miscellaneous/performance/district/level': ENTITY_TYPES.PERFORMANCE_DISTRICT_LEVEL,
        '/forms/miscellaneous/performance/operational/area': ENTITY_TYPES.PERFORMANCE_OPERATIONAL_AREA,
        '/forms/miscellaneous/performance/village/adoption': ENTITY_TYPES.PERFORMANCE_VILLAGE_ADOPTION,
        '/forms/miscellaneous/performance/district/priority-thrust': ENTITY_TYPES.PERFORMANCE_PRIORITY_THRUST,
        '/forms/miscellaneous/performance/infrastructure/demo-units': ENTITY_TYPES.PERFORMANCE_DEMONSTRATION_UNITS,
        '/forms/miscellaneous/performance/infrastructure/instructional-farm-crops': ENTITY_TYPES.PERFORMANCE_INSTRUCTIONAL_FARM_CROPS,
        '/forms/miscellaneous/performance/infrastructure/production-units': ENTITY_TYPES.PERFORMANCE_PRODUCTION_UNITS,
        '/forms/miscellaneous/performance/infrastructure/instructional-farm-livestock': ENTITY_TYPES.PERFORMANCE_INSTRUCTIONAL_FARM_LIVESTOCK,
        '/forms/miscellaneous/performance/infrastructure/hostel': ENTITY_TYPES.PERFORMANCE_HOSTEL,
        '/forms/miscellaneous/performance/infrastructure/staff-quarters': ENTITY_TYPES.PERFORMANCE_STAFF_QUARTERS,
        '/forms/miscellaneous/performance/infrastructure/rainwater-harvesting': ENTITY_TYPES.PERFORMANCE_RAINWATER_HARVESTING,
        '/forms/miscellaneous/performance/financial/budget-details': ENTITY_TYPES.PERFORMANCE_BUDGET_DETAILS,
        '/forms/miscellaneous/performance/financial/project-budget': ENTITY_TYPES.PERFORMANCE_PROJECT_BUDGET,
        '/forms/miscellaneous/performance/financial/revolving-fund': ENTITY_TYPES.PERFORMANCE_REVOLVING_FUND,
        '/forms/miscellaneous/performance/financial/revenue-generation': ENTITY_TYPES.PERFORMANCE_REVENUE_GENERATION,
        '/forms/miscellaneous/performance/financial/resource-generation': ENTITY_TYPES.PERFORMANCE_RESOURCE_GENERATION,
        '/forms/miscellaneous/performance/linkages/functional-linkage': ENTITY_TYPES.PERFORMANCE_FUNCTIONAL_LINKAGE,
        '/forms/miscellaneous/performance/linkages/special-programmes': ENTITY_TYPES.PERFORMANCE_SPECIAL_PROGRAMMES,
