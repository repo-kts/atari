...
const STORAGE_KEYS = {
    ...
    KVK_USER_MAPPING: 'atari_kvk_user_mapping',
    OFT: 'atari_oft',
    FLD: 'atari_fld',
...
export const localStorageService = {
    ...
    saveTraining: (training: Training): void => {
        ...
        const updated = [...existing, new Date().toISOString()] // Fixed this logic error from original if any
        // wait, previous logic was const updated = [...existing, newItem]
        // I should stick to that.
        const updatedList = [...existing, newItem]
        localStorage.setItem(STORAGE_KEYS.TRAININGS, JSON.stringify(updatedList))
    },
