...
const ENTITY_HOOK_MAP: Record<string, HookFactory> = {
    ...
    [ENTITY_TYPES.JOB_TYPE]: () => useJobTypes(),
    ...
    [ENTITY_TYPES.UNIT]: () => useUnits(),
    [ENTITY_TYPES.CROP_TYPE]: () => useCropTypes(),
    [ENTITY_TYPES.INFRASTRUCTURE_MASTER]: () => useInfrastructureMasters(),
    [ENTITY_TYPES.LAND_ITEM_MASTER]: () => useLandItemMasters(),
    [ENTITY_TYPES.BUDGET_ITEM_MASTER]: () => useBudgetItemMasters(),
    ...
    // Miscellaneous
    [ENTITY_TYPES.MISC_PREVALENT_DISEASES_CROPS]: () => useProjectData(ENTITY_TYPES.MISC_PREVALENT_DISEASES_CROPS),
    [ENTITY_TYPES.MISC_PREVALENT_DISEASES_LIVESTOCK]: () => useProjectData(ENTITY_TYPES.MISC_PREVALENT_DISEASES_LIVESTOCK),
    [ENTITY_TYPES.MISC_NYK_TRAINING]: () => useProjectData(ENTITY_TYPES.MISC_NYK_TRAINING),
    [ENTITY_TYPES.MISC_POSHAN_MAAH]: () => useProjectData(ENTITY_TYPES.MISC_POSHAN_MAAH),
    [ENTITY_TYPES.MISC_PPV_FRA_TRAINING]: () => useProjectData(ENTITY_TYPES.MISC_PPV_FRA_TRAINING),
    [ENTITY_TYPES.MISC_PPV_FRA_PLANT_VARIETIES]: () => useProjectData(ENTITY_TYPES.MISC_PPV_FRA_PLANT_VARIETIES),
    [ENTITY_TYPES.MISC_RAWE_FET]: () => useProjectData(ENTITY_TYPES.MISC_RAWE_FET),
    [ENTITY_TYPES.MISC_VIP_VISITORS]: () => useProjectData(ENTITY_TYPES.MISC_VIP_VISITORS),
    [ENTITY_TYPES.MISC_SWACHHTA_SEWA]: () => useProjectData(ENTITY_TYPES.MISC_SWACHHTA_SEWA),
    [ENTITY_TYPES.MISC_SWACHHTA_PAKHWADA]: () => useProjectData(ENTITY_TYPES.MISC_SWACHHTA_PAKHWADA),
    [ENTITY_TYPES.MISC_SWACHHTA_BUDGET]: () => useProjectData(ENTITY_TYPES.MISC_SWACHHTA_BUDGET),
    [ENTITY_TYPES.MISC_MEETINGS_SAC]: () => useProjectData(ENTITY_TYPES.MISC_MEETINGS_SAC),
    [ENTITY_TYPES.MISC_MEETINGS_OTHER]: () => useProjectData(ENTITY_TYPES.MISC_MEETINGS_OTHER),

    // Digital Information
    [ENTITY_TYPES.MISC_DIGITAL_MOBILE_APP]: () => useProjectData(ENTITY_TYPES.MISC_DIGITAL_MOBILE_APP),
    [ENTITY_TYPES.MISC_DIGITAL_WEB_PORTAL]: () => useProjectData(ENTITY_TYPES.MISC_DIGITAL_WEB_PORTAL),
    [ENTITY_TYPES.MISC_DIGITAL_KISAN_SARATHI]: () => useProjectData(ENTITY_TYPES.MISC_DIGITAL_KISAN_SARATHI),
    [ENTITY_TYPES.MISC_DIGITAL_KISAN_MOBILE_ADVISORY]: () => useProjectData(ENTITY_TYPES.MISC_DIGITAL_KISAN_MOBILE_ADVISORY),
    [ENTITY_TYPES.MISC_DIGITAL_OTHER_CHANNELS]: () => useProjectData(ENTITY_TYPES.MISC_DIGITAL_OTHER_CHANNELS),

    // Performance Indicators - Impact
    [ENTITY_TYPES.PERFORMANCE_IMPACT_KVK_ACTIVITIES]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_IMPACT_KVK_ACTIVITIES),
    [ENTITY_TYPES.PERFORMANCE_IMPACT_ENTREPRENEURSHIP]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_IMPACT_ENTREPRENEURSHIP),
    [ENTITY_TYPES.PERFORMANCE_IMPACT_SUCCESS_STORIES]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_IMPACT_SUCCESS_STORIES),

    // Performance Indicators - Infrastructure
    [ENTITY_TYPES.PERFORMANCE_DEMONSTRATION_UNITS]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_DEMONSTRATION_UNITS),
    [ENTITY_TYPES.PERFORMANCE_INSTRUCTIONAL_FARM_CROPS]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_INSTRUCTIONAL_FARM_CROPS),
    [ENTITY_TYPES.PERFORMANCE_PRODUCTION_UNITS]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_PRODUCTION_UNITS),
    [ENTITY_TYPES.PERFORMANCE_INSTRUCTIONAL_FARM_LIVESTOCK]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_INSTRUCTIONAL_FARM_LIVESTOCK),
    [ENTITY_TYPES.PERFORMANCE_HOSTEL]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_HOSTEL),
    [ENTITY_TYPES.PERFORMANCE_STAFF_QUARTERS]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_STAFF_QUARTERS),
    [ENTITY_TYPES.PERFORMANCE_RAINWATER_HARVESTING]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_RAINWATER_HARVESTING),

    // Performance Indicators - District & Village
    [ENTITY_TYPES.PERFORMANCE_DISTRICT_LEVEL]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_DISTRICT_LEVEL),
    [ENTITY_TYPES.PERFORMANCE_OPERATIONAL_AREA]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_OPERATIONAL_AREA),
    ...
    [ENTITY_TYPES.PERFORMANCE_REVENUE_GENERATION]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_REVENUE_GENERATION),
    [ENTITY_TYPES.PERFORMANCE_RESOURCE_GENERATION]: () => useProjectData(ENTITY_TYPES.PERFORMANCE_RESOURCE_GENERATION),
};
