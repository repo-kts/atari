...
export function TableView({ data, fk, idPrefix = 'raw' }: TableViewProps) {
            ...
            <tbody>
                {rows.map(({ row, index }) => {
                    ...
                    return (
                        ...
                        >
                            <td className={`sticky left-0 z-10 border-b border-r border-gray-200 px-3 py-2 text-gray-400 group-hover:bg-blue-50/80 transition-colors shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] ${
