...
const sections: FeatureSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Important Events', path: ROUTE_PATHS.ACHIEVEMENTS.CELEBRATION_DAYS, moduleCode: 'achievements_celebration_days' },
            ...
            { label: 'Poshan Maah', path: ROUTE_PATHS.ACHIEVEMENTS.POSHAN_MAAHA, moduleCode: 'misc_poshan_maah' },
        ],
    },
    {
