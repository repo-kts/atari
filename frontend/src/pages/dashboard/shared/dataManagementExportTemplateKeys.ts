...
> = {
    ...
    [ENTITY_TYPES.PROJECT_NICRA_CONVERGENCE]: 'nicra-convergence',
    [ENTITY_TYPES.PROJECT_NICRA_DIGNITARIES]: 'nicra-dignitaries',
    ...
    [ENTITY_TYPES.PROJECT_NICRA_PI_COPI]: 'nicra-pi-copi',
    [ENTITY_TYPES.PROJECT_NATURAL_FARMING_GEO]: 'natural-farming-geo',
    ...
    [ENTITY_TYPES.PROJECT_TSP_ACTIVITY]: 'tsp',
