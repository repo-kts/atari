        ...
        <div className="bg-white rounded-2xl p-1">
            ...
            <Card className="bg-[#FAF9F6]">
                <CardContent className="p-6">
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-[#487749]">Targets</h2>
                        <p className="text-sm text-[#757575] mt-1">
                            Set and monitor institutional and individual targets
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-[#E0E0E0] p-12 text-center">
                        <div className="max-w-md mx-auto">
                            <div className="w-16 h-16 bg-[#487749]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                <Target className="w-8 h-8 text-[#487749]" />
                            </div>
                            <h3 className="text-lg font-medium text-[#212121] mb-2">Target Management</h3>
                            <p className="text-[#757575] mb-6">Targets management content will be implemented here. Define annual and quarterly goals for various activities.</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
