...
export const projectsRoutes: RouteConfig[] = [
    ...
    // DRMR
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Varieties used in IP', 'Situations (Irrigated/ Rainfed)', 'Varieties used in FP', 'Net Return Improved Practice(Rs./ha)', 'Net Return Farmer Practice(Rs./ha)'],
        siblings: [
    ...
    // NICRA
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK', 'RF(mm) district Normal', 'RF(mm) district Received', 'Max temperature 0C', 'Min temperature 0C'],
        siblings: [
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Category', 'Sub Category', 'Season', 'Technology Demonstrated', 'Area (ha)/ Unit', 'Number of farmers attended'],
        siblings: [
            '/forms/achievements/projects/nicra/basic-information',
            '/forms/achievements/projects/nicra/training',
            '/forms/achievements/projects/nicra/details',
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Title', 'Start Date', 'End Date', 'Number of farmers attended'],
        siblings: [
            '/forms/achievements/projects/nicra/basic-information',
            '/forms/achievements/projects/nicra/training',
            '/forms/achievements/projects/nicra/details',
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Activity Name', 'Places', 'Start Date', 'End Date', 'Number of farmers attended'],
        siblings: [
            '/forms/achievements/projects/nicra/basic-information',
            '/forms/achievements/projects/nicra/training',
            '/forms/achievements/projects/nicra/details',
    ...
    // Natural Farming
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Start Date', 'End Date', 'Agro Climatic Zone', 'Farming Situation of selected farmer', 'Latitude', 'Longitude'],
        siblings: [
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Farmer Name', 'Name of activity', 'Crop', 'Variety'],
        siblings: [
            '/forms/achievements/projects/natural-farming/geographical-information',
            '/forms/achievements/projects/natural-farming/physical-information',
            '/forms/achievements/projects/natural-farming/demonstration-information',
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Farmer Name', 'Address', 'Normal Crops grown', 'Practicing year of natural farming'],
        siblings: [
            '/forms/achievements/projects/natural-farming/geographical-information',
            '/forms/achievements/projects/natural-farming/physical-information',
            '/forms/achievements/projects/natural-farming/demonstration-information',
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK Name', 'Season', 'Type', 'Crop', 'Before pH', 'Before EC (ds/m)', 'Before EC OC(%)', 'After pH', 'After EC (ds/m)', 'After EC OC(%)'],
        siblings: [
            '/forms/achievements/projects/natural-farming/geographical-information',
            '/forms/achievements/projects/natural-farming/physical-information',
            '/forms/achievements/projects/natural-farming/demonstration-information',
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['Year', 'KVK Name', 'Activity Name', 'Number of Activities Organised', 'Budget Sanctioned(Rs)', 'Budget Expenditure(Rs)', 'Total Budget Expenditure(Rs)'],
        siblings: [
            '/forms/achievements/projects/natural-farming/geographical-information',
            '/forms/achievements/projects/natural-farming/physical-information',
            '/forms/achievements/projects/natural-farming/demonstration-information',
    ...
    },
    {
        ...
        parent: '/forms/achievements/projects',
        moduleCode: 'achievements_projects',
        fields: ['KVK', 'Name of the programme', 'Date of the programme', 'Venue', 'Purpose', 'No. of participants'],
    },
]
