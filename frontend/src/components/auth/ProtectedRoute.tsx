...
export const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
    ...
    // Check explicit role deny list first
    if (deniedRoles) {
        const blockedRoles = Array.isArray(deniedRoles) ? deniedRoles : [deniedRoles]
        const normalizedBlockedRoles = blockedRoles.map(role => role.toLowerCase())
        if (normalizedBlockedRoles.includes(user.role.toLowerCase())) {
            return (
