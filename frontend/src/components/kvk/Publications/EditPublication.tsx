...
export const EditPublication: React.FC<EditPublicationProps> = ({ publication, onSuccess, onCancel }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        localStorageService.updatePublication(publication.id, formData)
        onSuccess()
    }
