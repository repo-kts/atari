...
interface AddTechnologyWeekProps {
    onSuccess: () => void
    onCancel: () => void
}

export const AddTechnologyWeek: React.FC<AddTechnologyWeekProps> = ({ onSuccess, onCancel }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newActivity: TechnologyWeek = {
            id: Date.now(),
            kvk_id: user?.kvkId || 0,
        ...
        localStorageService.saveTechnologyWeek(newActivity)
        onSuccess()
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="e.g., Seminar, Exhibition"
                    />
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea
                        ...
                        placeholder="Enter details about related technology..."
                    />
                </div>
            </div>
