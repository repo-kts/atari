...
interface EditExtensionActivityProps {
    activity: ExtensionActivity
    onSuccess: () => void
    onCancel: () => void
}

export const EditExtensionActivity: React.FC<EditExtensionActivityProps> = ({ activity, onSuccess, onCancel }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        localStorageService.updateExtensionActivity(activity.id, formData)
        onSuccess()
    }
