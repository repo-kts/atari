  ...
  kvk_admin: {
    permissions: {
      modules: [
        ...
        'all_masters_impact_area_master', 'all_masters_demo_unit_name_master', 'all_masters_enterprise_type_master', 'all_masters_account_type_master', 'all_masters_programme_type_master',
