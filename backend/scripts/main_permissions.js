...
const MODULES = [
  ...
  { menuName: 'Targets', subMenuName: '뿯ν뿯½뿯½', moduleCode: 'targets' },
  { menuName: 'Log History', subMenuName: '뿯ν뿯½뿯½', moduleCode: 'log_history' },
  { menuName: 'Notifications', subMenuName: '뿯ν뿯½뿯½', moduleCode: 'notifications' },
  { menuName: 'Reports', subMenuName: '뿯ν뿯½뿯½', moduleCode: 'reports' },
];
...
const BASE_USER_MODULES = [
  ...
  'achievements_hrd', 'performance_indicators_impact', 'performance_indicators_infrastructure',
...
async function run() {
  console.log('≡뿯ƽ뿯½뿯▽ Permissions (modules + role assignments)\n');
  ...
  console.log(`   뿯ν뿯½뿯½ ${createdModules} new modules, ${createdPermissions} new permissions\n`);
  ...
  for (const [roleName, config] of Object.entries(ROLE_PERMISSIONS)) {
    ...
    console.log(`   뿯ν뿯½뿯½ ${roleName}: ${permissionIds.length} permissions`);
  }
  console.log('');
}
