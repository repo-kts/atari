...
const REGISTRY = [
  ...
  { key: 'about_kvk.equipments', title: 'View Equipments', category: 'About KVK', moduleCode: 'about_kvks_view_equipments', model: 'kvkEquipment', path: '/forms/about-kvk/equipments' },
  ...
  { key: 'achievements.celebration_days', title: 'Important Events', category: 'Achievements', moduleCode: 'achievements_celebration_days', model: 'kvkImportantDayCelebration', path: '/forms/achievements/celebration-days' },
  ...
  { key: 'achievements.world_soil_day', title: 'World Soil Day', category: 'Achievements', subcategory: 'Soil & Water Testing', moduleCode: 'achievements_world_soil_day', model: 'kkvWorldSoilCelebration', path: '/forms/achievements/world-soil-day' },
  ...
  { key: 'achievements.awards_scientist', title: 'Awards (Scientist)', category: 'Achievements', subcategory: 'Awards', moduleCode: 'achievements_award_scientist', model: 'scientistAward', path: '/forms/achievements/awards/scientist' },
  { key: 'achievements.awards_farmer', title: 'Awards (Farmer)', category: 'Achievements', subcategory: 'Awards', moduleCode: 'achievements_award_farmer', model: 'farmerAward', path: '/forms/achievements/awards/farmer' },
  ...
  { key: 'performance.impact_entrepreneurship', title: 'Entrepreneurship', category: 'Performance Indicators', subcategory: 'Impact', moduleCode: 'performance_indicators_entrepreneurship', model: 'entrepreneurship', path: '/forms/performance/impact/entrepreneurship' },
  { key: 'performance.impact_success_stories', title: 'Success Stories', category: 'Performance Indicators', subcategory: 'Impact', moduleCode: 'performance_indicators_success_stories', model: 'successStory', path: '/forms/performance/impact/success-stories' },

  { key: 'performance.district_level', title: 'District Level Data', category: 'Performance Indicators', subcategory: 'District & Village', moduleCode: 'performance_indicators_district_level_data', model: 'districtLevelData', path: '/forms/performance/district-village/district-level' },
  { key: 'performance.operational_area', title: 'Operational Area', category: 'Performance Indicators', subcategory: 'District & Village', moduleCode: 'performance_indicators_operational_area', model: 'operationalArea', path: '/forms/performance/district-village/operational-area' },
  { key: 'performance.village_adoption', title: 'Village Adoption', category: 'Performance Indicators', subcategory: 'District & Village', moduleCode: 'performance_indicators_village_adoption', model: 'villageAdoption', path: '/forms/performance/district-village/village-adoption' },
  { key: 'performance.priority_thrust', title: 'Priority Thrust Area', category: 'Performance Indicators', subcategory: 'District & Village', moduleCode: 'performance_indicators_priority_thrust_area', model: 'priorityThrustArea', path: '/forms/performance/district-village/priority-thrust' },

  { key: 'performance.demonstration_units', title: 'Demonstration Units', category: 'Performance Indicators', subcategory: 'Infrastructure', moduleCode: 'performance_indicators_demonstration_units', model: 'demonstrationUnit', path: '/forms/performance/infrastructure/demonstration-units' },
  { key: 'performance.instructional_crops', title: 'Instructional Farm (Crops)', category: 'Performance Indicators', subcategory: 'Infrastructure', moduleCode: 'performance_indicators_instructional_farm_crops', model: 'instructionalFarmCrop', path: '/forms/performance/infrastructure/instructional-farm-crops' },
  { key: 'performance.production_units', title: 'Production Units', category: 'Performance Indicators', subcategory: 'Infrastructure', moduleCode: 'performance_indicators_production_units', model: 'productionUnit', path: '/forms/performance/infrastructure/production-units' },
  { key: 'performance.instructional_livestock', title: 'Instructional Farm (Livestock)', category: 'Performance Indicators', subcategory: 'Infrastructure', moduleCode: 'performance_indicators_instructional_farm_livestock', model: 'instructionalFarmLivestock', path: '/forms/performance/infrastructure/instructional-farm-livestock' },
  { key: 'performance.hostel', title: 'Hostel Facilities', category: 'Performance Indicators', subcategory: 'Infrastructure', moduleCode: 'performance_indicators_hostel_facilities', model: 'hostelUtilization', path: '/forms/performance/infrastructure/hostel' },
  { key: 'performance.staff_quarters', title: 'Staff Quarters', category: 'Performance Indicators', subcategory: 'Infrastructure', moduleCode: 'performance_indicators_staff_quarters', model: 'staffQuartersUtilization', path: '/forms/performance/infrastructure/staff-quarters' },
  { key: 'performance.rainwater', title: 'Rain Water Harvesting', category: 'Performance Indicators', subcategory: 'Infrastructure', moduleCode: 'performance_indicators_rainwater_harvesting', model: 'rainwaterHarvesting', path: '/forms/performance/infrastructure/rainwater-harvesting' },

  { key: 'performance.budget_details', title: 'Budget Details', category: 'Performance Indicators', subcategory: 'Financial', moduleCode: 'performance_indicators_budget_details', model: 'budgetDetail', path: '/forms/performance/financial/budget-details' },
  { key: 'performance.project_budget', title: 'Project-wise Budget', category: 'Performance Indicators', subcategory: 'Financial', moduleCode: 'performance_indicators_project_budget', model: 'projectBudget', path: '/forms/performance/financial/project-budget' },
  { key: 'performance.revolving_fund', title: 'Revolving Fund', category: 'Performance Indicators', subcategory: 'Financial', moduleCode: 'performance_indicators_revolving_fund', model: 'revolvingFund', path: '/forms/performance/financial/revolving-fund' },
  { key: 'performance.revenue_generation', title: 'Revenue Generation', category: 'Performance Indicators', subcategory: 'Financial', moduleCode: 'performance_indicators_revenue_generation', model: 'revenueGeneration', path: '/forms/performance/financial/revenue-generation' },
  { key: 'performance.resource_generation', title: 'Resource Generation', category: 'Performance Indicators', subcategory: 'Financial', moduleCode: 'performance_indicators_resource_generation', model: 'resourceGeneration', path: '/forms/performance/financial/resource-generation' },
