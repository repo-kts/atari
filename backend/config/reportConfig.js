...
const reportConfig = {
    ...
    sections: [
        ...
        // ── Achievements ───────────────────────────────────
        {
            ...
            description: 'Target vs achievement across OFT, FLD, Training, Extension, Other Extension and Production',
            subsection: true,
            parentSectionId: '2',
...

        {
            ...
            description: 'Publication details grouped by KVK and publication item',
            subsection: true,
            parentSectionId: '2',
            dataSource: 'kvkPublicationDetails',
            format: 'custom',
            customTemplate: 'publication-details-detailed',
            filters: {
                dateFields: ['reportingYear'],
                yearFields: ['reportingYear'],
            },
            fields: [
                { dbField: 'category', displayName: 'Publication Item' },
                { dbField: 'title', displayName: 'Title' },
                { dbField: 'authorName', displayName: 'Author Name' },
                { dbField: 'journalName', displayName: 'Journal Name' },
                { dbField: 'pageNo', displayName: 'Page Number' },
                { dbField: 'naasRating', displayName: 'NAAS Rating' },
                { dbField: 'publisherName', displayName: 'Publisher Name' },
                { dbField: 'venue', displayName: 'Venue' },
                { dbField: 'isbnNumber', displayName: 'ISBN Number' },
            ],
        },
        {
            id: '2.56',
        ...
        },
        {
            id: '2.41',
            title: 'NICRA – Details',
            description: 'NICRA details with technology demonstrated and economics',
            subsection: true,
            parentSectionId: '3',
            dataSource: 'nicraDetails',
            format: 'custom',
            customTemplate: 'nicra-details',
            filters: {
                dateFields: ['reportingYear'],
                yearFields: ['reportingYear'],
            },
        ...
        {
            id: '2.42',
            title: 'NICRA – Revenue Generated',
            description: 'Revenue generated under NICRA',
            subsection: true,
            parentSectionId: '3',
            dataSource: 'nicraRevenueGenerated',
            format: 'table',
            filters: {
                dateFields: ['reportingYear'],
                yearFields: ['reportingYear'],
            ...
            fields: [
                ...
                { dbField: 'revenueGeneratedRs', displayName: 'Revenue Generated (Rs.)', type: 'currency' },
            ],
        },
        {
            id: '2.43',
            title: 'NICRA – Convergence Programme',
            description: 'Convergence programme details under NICRA',
            subsection: true,
            parentSectionId: '3',
            dataSource: 'nicraConvergence',
            format: 'custom',
            customTemplate: 'nicra-convergence',
            filters: {
                dateFields: ['startDate', 'endDate'],
                yearFields: ['startDate', 'endDate'],
            },
        ...
        {
            id: '2.45',
            title: 'NICRA – Dignitaries Visited',
            description: 'Dignitaries visited NICRA villages',
            subsection: true,
            parentSectionId: '3',
            dataSource: 'nicraDignitaries',
            format: 'custom',
            customTemplate: 'nicra-dignitaries',
            filters: {
                dateFields: ['dateOfVisit'],
                yearFields: ['dateOfVisit'],
            },
            fields: [],
        },
        {
            id: '2.61',
            title: 'NICRA – PI/Co-PI List',
            description: 'PI and Co-PI list under NICRA',
            subsection: true,
            parentSectionId: '3',
            dataSource: 'nicraPiCopi',
            format: 'custom',
            customTemplate: 'nicra-pi-copi',
            filters: {
                dateFields: ['startDate', 'endDate'],
                yearFields: ['startDate', 'endDate'],
            },
        ...
        {
            id: '2.60',
            title: 'Natural Farming – Geographical Information',
            description: 'Geographical information under Natural Farming',
            subsection: true,
            parentSectionId: '3',
            dataSource: 'naturalFarmingGeographical',
            format: 'custom',
            customTemplate: 'natural-farming-geo',
            filters: {
                dateFields: ['reportingYear', 'startDate', 'endDate'],
                yearFields: ['reportingYear', 'startDate', 'endDate'],
            },
            fields: [],
        },
        {
        ...
        {
            id: '2.48',
            title: 'Natural Farming – Beneficiaries',
            description: 'Beneficiary details under Natural Farming',
            subsection: true,
            parentSectionId: '3',
            dataSource: 'naturalFarmingBeneficiaries',
            format: 'custom',
            customTemplate: 'natural-farming-beneficiaries',
            filters: {
