...
const swachhtaBharatController = {
    hiSewa: createControllerLayer(swachhtaBharatService.hiSewa),
    pakhwada: createControllerLayer(swachhtaBharatService.pakhwada),
    budget: createControllerLayer(swachhtaBharatService.budget),
};

module.exports = swachhtaBharatController;
