...
<div id="${sectionId}" class="${pageClass}">
    ...
    <table class="data-table" style="width:100%;">
        <thead>
            <tr>
                <th rowspan="3" style="vertical-align:bottom;">KVK</th>
                <th rowspan="3" style="vertical-align:bottom;">Date of training/awareness programme</th>
                <th rowspan="3" style="vertical-align:bottom;">Title</th>
                <th rowspan="3" style="vertical-align:bottom;">Type</th>
                <th rowspan="3" style="vertical-align:bottom;">Venue</th>
                <th rowspan="3" style="vertical-align:bottom;">Resource Person</th>
    ...
    if (records.length === 0) {
        html += `
            <tr>
                <td colspan="21" style="text-align:center;color:#666;font-style:italic;padding:12px;">No data available for this section.</td>
            </tr>`;
    }
