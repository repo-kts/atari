const nicraBasicInfoRepository = require('../../repositories/forms/nicraBasicInfoRepository.js');
const nicraTrainingRepository = require('../../repositories/forms/nicraTrainingRepository.js');
const nicraExtensionActivityRepository = require('../../repositories/forms/nicraExtensionActivityRepository.js');
const nicraDetailsRepository = require('../../repositories/forms/nicraDetailsRepository.js');
const nicraInterventionRepository = require('../../repositories/forms/nicraInterventionRepository.js');
...
const nicraVcrmcRepository = require('../../repositories/forms/nicraVcrmcRepository.js');
const nicraSoilHealthRepository = require('../../repositories/forms/nicraSoilHealthRepository.js');
const nicraConvergenceRepository = require('../../repositories/forms/nicraConvergenceRepository.js');
const nicraDignitariesRepository = require('../../repositories/forms/nicraDignitariesRepository.js');
const nicraPiCopiRepository = require('../../repositories/forms/nicraPiCopiRepository.js');
const nicraMasterRepository = require('../../repositories/all-masters/nicraMasterRepository.js');
