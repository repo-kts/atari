    ...
    create: async (data, user) => {
        ...
        const result = await prisma.nariBioFortifiedCrop.create({
            data: {
                ...
                cropCategoryId,
                cropCategoryOther: (data.cropCategoryOther && String(data.cropCategoryOther).trim()) || null,
                nameOfCrop: cropName,
    ...
    update: async (id, data) => {
        const result = await prisma.nariBioFortifiedCrop.update({
            ...
            data: {
                ...
                cropCategoryOther: data.cropCategoryOther !== undefined ? ((String(data.cropCategoryOther).trim()) || null) : undefined,
...
function _mapResponse(r) {
    ...
    return {
        ...
        cropCategoryName: r.cropCategoryOther || r.cropCategory?.name,
        cropCategoryOther: r.cropCategoryOther ?? '',
