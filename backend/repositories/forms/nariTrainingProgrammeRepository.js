...
function normalizeCampusType(value) {
    ...
    if (normalized.includes('OFF')) return 'OFF_CAMPUS';
    return 'ON_CAMPUS';
}

const nariTrainingProgrammeRepository = {
        ...
        const result = await prisma.nariTrainingProgramme.update({
            ...
            data: {
                ...
                nameOfNutriSmartVillage: data.nameOfNutriSmartVillage !== undefined || data.villageName !== undefined
                    ...
                    : undefined,
                areaOfTraining: data.areaOfTraining !== undefined || data.trainingArea !== undefined
                    ? (data.areaOfTraining ?? data.trainingArea)
                    : undefined,
                titleOfTraining: data.titleOfTraining !== undefined || data.trainingTitle !== undefined
                    ? (data.titleOfTraining ?? data.trainingTitle)
                    : undefined,
