    ...
    create: async (data, opts, user) => {
        ...
        return await prisma.craDetails.create({
            data: {
                ...
                croppingSystemOther: (data.croppingSystemOther && String(data.croppingSystemOther).trim()) || null,
                farmingSystemId: data.farmingSystemId ? parseInt(data.farmingSystemId) : null,
                farmingSystemOther: (data.farmingSystemOther && String(data.farmingSystemOther).trim()) || null,
    ...
    update: async (id, data, user) => {
        ...
        const result = await prisma.craDetails.update({
            ...
            data: {
                ...
                croppingSystemOther: data.croppingSystemOther !== undefined ? ((String(data.croppingSystemOther).trim()) || null) : undefined,
                farmingSystemId: data.farmingSystemId !== undefined ? (data.farmingSystemId ? parseInt(data.farmingSystemId) : null) : undefined,
                farmingSystemOther: data.farmingSystemOther !== undefined ? ((String(data.farmingSystemOther).trim()) || null) : undefined,
...
function _mapResponse(r) {
    ...
    return {
        ...
        croppingSystem: r.croppingSystemOther || r.croppingSystem,
        cropingSystem: r.croppingSystemOther || r.croppingSystem,
        croppingSystemId: r.croppingSystemId ?? null,
        croppingSystemOther: r.croppingSystemOther ?? '',
        farmingSystemName: r.farmingSystemOther || (r.farmingSystem ? r.farmingSystem.farmingSystemName : ''),
        farmingSystemId: r.farmingSystemId ?? null,
        farmingSystemOther: r.farmingSystemOther ?? '',
