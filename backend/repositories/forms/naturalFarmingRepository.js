...
const demonstrationInfoRepository = {
    create: async (data, user) => {
        ...
        const mappedData = {
            ...
            staffCategoryOther: (data.staffCategoryOther && String(data.staffCategoryOther).trim()) || null,
    ...
    findAll: async (filters, user) => {
        ...
        return records.map(r => ({
            ...
            staffCategoryName: r.staffCategoryOther || r.staffCategory?.categoryName || null,
            ...
            season: r.seasonOther || r.season?.seasonName,
            area: r.areaInHa,
            startDate: r.startDate ? r.startDate.toISOString().split('T')[0] : null,
            endDate: r.endDate ? r.endDate.toISOString().split('T')[0] : null,
    ...
    update: async (id, data, user) => {
        ...
        return await prisma.demonstrationInfo.update({
            ...
            data: {
                ...
                staffCategoryOther: data.staffCategoryOther !== undefined ? ((String(data.staffCategoryOther).trim()) || null) : existing.staffCategoryOther,
...
const soilDataRepository = {
    create: async (data, user) => {
        ...
        return await prisma.soilDataInformation.create({
            data: {
                ...
                seasonOther: (data.seasonOther && String(data.seasonOther).trim()) || null,
                soilParameterId,
                // "Other" free-text: only meaningful when the chosen soil-parameter row is flagged isOther.
                soilParameterOther: (data.soilParameterOther && String(data.soilParameterOther).trim()) || null,
    ...
    findAll: async (filters, user) => {
        ...
        return records.map(r => ({
            ...
            seasonId: r.seasonId,
            reportingYear: formatLegacyYearResponse(r.reportingYearDate, r.year),
            parameterName: r.soilParameterOther || r.soilParameterMaster?.parameterName || null,
            type: r.soilParameterOther || r.soilParameterMaster?.parameterName || null,
            soilParameter: r.soilParameterOther || r.soilParameterMaster?.parameterName || null,
            soilParameterId: r.soilParameterId,
            soilParameterOther: r.soilParameterOther ?? '',
            crop: r.crop,
            beforePh: r.phBefore,
            beforeEc: r.ecBefore,
            beforeOc: r.ocBefore,
    ...
    update: async (id, data, user) => {
        ...
        return await prisma.soilDataInformation.update({
            ...
            data: {
                ...
                seasonOther: data.seasonOther !== undefined ? ((String(data.seasonOther).trim()) || null) : existing.seasonOther,
                soilParameterId: resolvedSoilParameterId,
                soilParameterOther: data.soilParameterOther !== undefined ? ((String(data.soilParameterOther).trim()) || null) : undefined,
